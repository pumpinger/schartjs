...
//                        console.log(parenttext.node.getComputedTextLength());
        ...
        function drawPie(dom,data,legend,fun,option,nodataStr){
            ...
            function drawTip(color,v){
                ...
                if(typeof  data[0].time == 'undefined'){
                    var text=svg.text(vw/2,tb-((tb-tt)-10)/2, [legend[0]+':　','￥',_formatMoney(v.price)+'　', v.num,'笔']).attr({fill:'#fff','class':"svgpietip",fontSize:14});
        ...
        function drawPcColumn(dom,data,legend,fun,nodataStr){
            fontColor="#333333";
            isPc=true;

            var option= _pcScreen(dom);

            drawColumn(dom,data,legend,fun,option,nodataStr);
        }

        function drawPcLine(dom,data,legend,fun,nodataStr){
        ...
        function drawPcBar(dom,data,legend,fun,nodataStr){
            fontColor="#333333";
            isPc=true;
            var option= _pcScreen(dom);
        ...
        function drawPcPie(dom,data,legend,fun,nodataStr){
            fontColor="#333333";
            isPc=true;

            $(dom).removeAttr('viewBox');

            drawPie(dom,data,legend,fun,nodataStr);
        }
